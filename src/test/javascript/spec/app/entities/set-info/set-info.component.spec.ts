...
import { SetInfoComponent } from 'app/entities/set-info/set-info.component';
import { SetInfoService } from 'app/entities/set-info/set-info.service';
import { SetInfo } from 'app/shared/model/set-info.model';

describe('Component Tests', () => {
  describe('SetInfo Management Component', () => {
    let comp: SetInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SetInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.setInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
